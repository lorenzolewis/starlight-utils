...
To add tabs to the multi-sidebar, specify a label and directory for each tab you want to add. 
...
sidebar: [
    ...
    {label: 'Demos',
    autogenerate: { directory: 'Assessments' },
    badge: 'New',
    },
  ],
```

If the tab labels don't fit in the Sidebar width, a horizontal scroll bar will be added under the tabs.
